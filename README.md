...
#### Code Design
I did my best to keep scope as limited as possible while providing features and tooling that is robust but not rigid. I opted to use Service objects in this project because of the relatively low amount of overall complexity. I paid special attention to keeping the code SOLID so it can be easy to work with if was to be entended as well as provide a solid baseline for future code changes and the introduction of new paradigms. 
